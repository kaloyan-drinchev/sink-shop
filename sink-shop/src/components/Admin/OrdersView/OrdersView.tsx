                      ...
                      return (
                        <div key={item.id} className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <div className="text-xs text-gray-500">{t('admin.quantity')}: {item.quantity}</div>
                          </div>
                          <span className="font-medium">{isEnglish ? item.priceEur.toFixed(2) : item.priceBgn.toFixed(2)} {currency}</span>
                        </div>
                      );
                    })}
                  </div>
