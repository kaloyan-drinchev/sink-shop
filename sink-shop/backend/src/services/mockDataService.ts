...
export const mockProducts: Product[] = [
  ...
  // Type 4.1 - Marble
  {
    ...
    tag: { en: "Rectangular", bg: "Правоъгълен" },
    category: "marble",
    salesCount: 29,
    image: "",
    date: "2024-02-01",
...
export class MockDataService {
  ...
  static async createProduct(
    ...
    const existingProduct = mockProducts.find((p) => p.serialNumber === product.serialNumber);
    if (existingProduct) {
      throw new Error(`Serial number "${product.serialNumber}" already exists`);
    }
